...
#ifndef _ELISE_FONC_NUM_TPL_H
#define _ELISE_FONC_NUM_TPL_H

template <class Type> class Fonc_Num_Comp_TPL : public Fonc_Num_Computed
{
    public :
    ...
    private :
       ...
       static  Pack_Of_Pts::type_pack class_pack_out;
