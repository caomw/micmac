...
inline double_t rto_window_geom(double_t p,double_t t,double_t s)
{
    return (s*(p-(SIGN_TO_USER_GEOM *t)));
}

inline double_t rto_user_geom(double_t p,double_t t,double_t s)
{
    return (p/s+(SIGN_TO_USER_GEOM * t));
}


inline int ito_window_geom(double_t p,double_t t,double_t s)
{
    return round_ni(rto_window_geom(p,t,s));
}


inline int deb_interval_user_to_window(int a,double_t t,double_t s)
{
     return  round_up(rto_window_geom(a-0.5,t,s));
}

extern void interval_window_to_user(int & a1,int & a2,int u1,int u2,double_t t,double_t s);

extern void interval_user_to_window(int & u1,int & u2,int a1,int a2,double_t t,double_t s);


// compt tr,sc so that rto_window_geom(Ui,tr,sc) = Wi

extern void compute_tr_sc_from_exemple
            (double_t & tr,double_t & sc,double_t u1,double_t u2,double_t w1,double_t w2);

extern void compute_tr_from_exemple
            (double_t & tr,double_t sc,double_t u,double_t w);
...
class Data_Elise_Gra_Disp : public RC_Object
{
      ...
      public :
            ...
            inline double_t line_witdh() { return _last_line_width;}
      ...
      private :
            ...
            virtual void _inst_set_line_witdh(double_t) =0;
            inline void set_line_witdh(double_t lw)
            {
...
class Data_Elise_Gra_Win : public RC_Object
{
   ...
   protected :
        ...
        virtual void  _inst_draw_polyl(const double_t * x,const double_t *y,int nb);
                      // def value : draw nb-1 seg


        virtual void  _inst_draw_poly_segs
                       (const double_t * x1,const double_t *y1,
                        const double_t * x2,const double_t *y2,int nb);
...
class Data_El_Geom_GWin : public RC_Object
{
   ...
   private :
      ...
      void draw_polyl
      (
         const double_t * x,const double_t *y,int nb, Data_Line_St *,
         bool circ,
         bool auto_flush = true
      );
      void draw_polyl_cliped
      (
         const double_t * x,const double_t *y,int nb,Box2dr b, Data_Line_St *,
         bool circ,
         bool auto_flush = true
      );
