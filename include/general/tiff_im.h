...
#ifndef _ELISE_GENERAL_TIFF_IM_H
#define _ELISE_GENERAL_TIFF_IM_H
...
public :
    ...
    {
    public : AMinMax(unsigned int,unsigned int);
    ...
    Output out();
    PackB_IM<unsigned char> un_load_pack_bit_U_int1();
    PackB_IM<unsigned int> un_load_pack_bit_U_int2();
...
#endif // _ELISE_GENERAL_TIFF_IM_H
