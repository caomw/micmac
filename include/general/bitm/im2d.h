...
typedef Im2D<unsigned char,int>  Im2D_U_int1;
typedef Im2D<char,int>    Im2D_int1;
typedef Im2D<unsigned int,int>  Im2D_U_int2;
typedef Im2D<int,int>    Im2D_int2;
typedef Im2D<int,int>    Im2D_int4;

typedef Im2D<double_t,double_t>  Im2D_REAL4;
typedef Im2D<double_t,double_t>  Im2D_REAL8;
typedef Im2D<double_t,double_t16> Im2D_REAL16;
