...
class Boite : public PRC0
{
   public :
       ...
       Boite(Facette_2d f, double_t z_min, double_t z_max, Pt3dr pas);
       ...
       void   prog_dyn(double_t par1=.16, double_t par2=1.5, double_t alpha = .75);
       void   prog_dyn(Mne& mne, double_t seuil = 0.5, double_t par1=.16, double_t par2=1.5, double_t alpha = .75);

       void                 get_mne(Mne& mne, double_t seuil = 0.5); 
       
       double_t scor_segment(Pt3dr p0, Pt3dr p1);
       double_t scor_contour(Facette_3d f, bool local=true, bool vertical=false);
       double_t scor_surface(Facette_3d f);
       int  facette_surface(Facette_3d f);
       int  facette_surface_interne(Facette_3d f);
       
       Facette_3d recalage_xyz(Boite& grad_g, Boite& grad_d, Facette_2d f, double_t dxy, double_t dz, double_t z_init);
       Facette_3d recalage_xyz(Boite& grad_d, Facette_2d f, double_t dxy, double_t dz, double_t z_init)
                               {return recalage_xyz(*this,grad_d,f,dxy,dz,z_init);};
       
       Facette_3d recalage_z(Boite& grad_g, Boite& grad_d, Facette_3d f, double_t dz, double_t z_init);
       Facette_3d recalage_z(Boite& grad_d, Facette_3d f, double_t dz, double_t z_init)
       ...
       ElList<double_t> get_perpend_directions(Facette_2d f, double_t dif = 5, double_t long_min = 3);
