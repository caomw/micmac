...
Header-MicMac-eLiSe-25/06/2007*/
#ifndef    _HASSAN_STEREO_H
#define    _HASSAN_STEREO_H
...
class Cadastre
{
   ...
   public:
     ...
     void carte_to_terr(Ori3D_Std ori);
     void terr_to_carte(Ori3D_Std ori);

     void inside(Facette_2d f){};
...
//     H_Graphe _batiment;
     ...
     ChantierHJ(Stereo& stereo, Mne& mne, Cadastre& cad);

     bool write_batiment(char* f_name);
};
#endif   //_HASSAN_STEREO_H
