...
class Hplan : public PRC0
{
   public :
      ...
      Hplan(double_t A, double_t B, double_t C, double_t D); //, bool ort=true);
      Hplan(double_t teta, double_t phi, double_t rho);                //cos(t)cos(p)x+sin(t)cos(p)y+sin(p)z-rho=0   radian
...
//      Hplan* ptr();
      ...
      double_t         distance_max(Facette_3d f);                    //distance moyenne
