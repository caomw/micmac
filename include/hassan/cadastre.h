...
Header-MicMac-eLiSe-25/06/2007*/
#ifndef _HASSAN_CADASTRE_H
#define _HASSAN_CADASTRE_H
...
extern Pt2dr              cadastre_to_terrain(Pt2di p);
extern Facette_2d         cadastre_to_terrain(Facette_2d f);
extern ElList<Facette_2d> cadastre_to_terrain(ElList<Facette_2d> l); 

extern Facette_2d         cadastre_to_ortho(Facette_2d f, Pt2dr p0, Pt2dr d);
extern ElList<Facette_2d> cadastre_to_ortho(ElList<Facette_2d> l, Pt2dr p0, Pt2dr d);

extern bool               cadastre_inside(Facette_2d f, Cub3DTer C3d);
extern ElList<Facette_2d> cadastre_inside(ElList<Facette_2d> lf, Cub3DTer C3d);

extern ElList<Facette_2d> cadastre(Cub3DTer C3d, char* name);
extern void               cadastre(ElFilo<Facette_2d>& f_cad, Cub3DTer C3d, char* name);
extern ElList<Facette_2d> cadastre_amiens();

extern ElList<Facette_2d> read_cadastre_txt(char* name);
extern void               read_cadastre_txt(ElFilo<Facette_2d>& f_cad, char* name);
extern void               write_cadastre_txt(ElFilo<Facette_2d>& f_cad, char* name);
